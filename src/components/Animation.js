...
export const LoginAnimation = () => {
  return (
    <div className="w-full h_70 bg_drop_color flex items-center justify-center">
      <div className="loading-content relative h-52 w-52 rounded-full my-24 m-auto overflow-hidden dark:bg-transparent bg-gray-200">
        <div className="loading-content__center-part bg_drop_color relative top-2/4 left-6 z-50 h-40 w-40 transform -translate-y-2/4 rounded-full dark:bg-transparent bg-gray-200">
        <div className="flex bg_drop_color h-full w-full items-center justify-center">
        ...
        <div className="loading-content__loader absolute left-24 top-0 h-full w-4">
          <div className="loading-content__loader-content h-10 w-full bg-gradient-to-r from-blue-300 to-blue-500"></div>
        </div>
      </div>
    </div>
  );
